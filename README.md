...
SELECT 
  ...
  CASE WHEN t.amount > 5000 THEN 40
       WHEN t.amount > 1000 THEN 20
       ELSE 0 END AS amount_risk,
       
  CASE WHEN t.txn_country <> c.country THEN 35
       ELSE 0 END AS location_risk,
       
  CASE WHEN t.device_id LIKE '%-new' THEN 25
       ELSE 0 END AS device_risk,
       
  -- Total Score
  (
    CASE WHEN t.amount > 5000 THEN 40 WHEN t.amount > 1000 THEN 20 ELSE 0 END +
    CASE WHEN t.txn_country <> c.country THEN 35 ELSE 0 END +
